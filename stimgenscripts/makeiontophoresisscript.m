function [newscript,iontParams]=makeiontophoresisscript(thescript,currents,time,channels,doparam,reps)
...
%      TIME,CHANNELS,DOPARAM,REPS)
%
%  STIMSCRIPT - the original script to modify
%  CURRENTS - the current steps, in A
%  TIME - the duration, in secs; if empty, stim duration is used
