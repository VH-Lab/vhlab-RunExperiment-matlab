function [stimuli, mov, fithis]=genetic_simulation(kernel, N, max_n_generations,...
				    display,param)
%GENETIC_SIMULATION runs simulation of genetic algorithm 
%
%  [STIMULI, MOV, FITHIS]=GENETIC_SIMULATION(KERNEL, N, MAX_N_GENERATIONS, ...
%				    DISPLAY,PARAM)
%
...
if nargin<3
  max_n_generations=param.max_n_generations;
end
if nargin<2
  N=param.N;
end
...
for generation=1:max_n_generations
  ...
  disp(['Stimulus time elapsed: ' num2str( generation*N*param.repeats*...
