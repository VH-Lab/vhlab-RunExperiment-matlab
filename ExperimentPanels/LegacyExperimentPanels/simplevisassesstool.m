...
function params = sinewave(spikedata,r,d,sr)
  params.rect=recenterrect(r,[400 500 900 1000],sr); params.imageType=2; params.animType=4; 
  ...
  params.flickerType=0; params.distance=d; params.dispprefs={'BGpretime',2};
