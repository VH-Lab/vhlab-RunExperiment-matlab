...
uicontrol('unit','point','Style','popup',...
		...
		'callback','simplepopupmenucallback({''SimpleComplexSheet;'',''MultiMouseSheet;'',''BrainSurfaceImagingSheet;'',''FerretDirectionSheet;'',''TrainingSheet;'',''FerretLGNSheet;'',''LengthSummingSheet;'',''ImageBufferSheet;'',''ChR2ShenSheet;'',''ChR2ProjectorSheet;'',''ChR2Sheet;'',''FerretScrambleSheet;'',''MarjenaSheet;'',''FerretTripleVarySheet;''});');
