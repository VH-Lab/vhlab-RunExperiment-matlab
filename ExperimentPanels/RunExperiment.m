...
uicontrol('unit','point','Style','popup',...
		'String',{'SimpleComplex','MultiMouse','BrainSurfaceImaging','Ferret Direction','Ferret Training','Ferret LGN','Length Summing','Image Buffer','ChR2 Shen','ChR2 Projector','ChR2','Ferret Scramble','MarjenaSheet','FerretTripleVarySheet','Vikko_Sheet'},...
		'position',[130 100+st-25 300 20],...
		'callback','simplepopupmenucallback({''SimpleComplexSheet;'',''MultiMouseSheet;'',''BrainSurfaceImagingSheet;'',''FerretDirectionSheet;'',''TrainingSheet;'',''FerretLGNSheet;'',''LengthSummingSheet;'',''ImageBufferSheet;'',''ChR2ShenSheet;'',''ChR2ProjectorSheet;'',''ChR2Sheet;'',''FerretScrambleSheet;'',''MarjenaSheet;'',''FerretTripleVarySheet;'',''Vikko_Sheet''});');
