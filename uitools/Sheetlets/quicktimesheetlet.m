function [hlist,lengthwidth] = quicktimesheetlet(title,typeName,upperLeft)

button.Units = 'pixels';
button.BackgroundColor = [0.8 0.8 0.8];
button.HorizontalAlignment = 'center';
button.Callback = ['sheetlet_callback(''quicktimesheetlet_process'',''' typeName ''');'];
...
h = uicontrol(txt,'position',[upperLeft(1)+10 upperLeft(2)-7 100 20],'string','Quicktime','Tag',[typeName 'QTtxt'], 'fontweight', 'bold', 'horizontalalignment', 'left');
hlist = [hlist h];
