function [hlist,lengthwidth] = reversecorrelationsheetlet(title,typeName,upperLeft)

button.Units = 'pixels';
button.BackgroundColor = [0.8 0.8 0.8];
button.HorizontalAlignment = 'center';
button.Callback = ['sheetlet_callback(''reversecorrelationsheetlet_process'',''' typeName ''');'];
...
h = uicontrol(txt,'position',[upperLeft(1)+10 upperLeft(2)-7 200 20],'string','Reverse Correlation','Tag',[typeName 'RCtxt'], 'fontweight', 'bold', 'horizontalalignment', 'left');
hlist = [hlist h];
