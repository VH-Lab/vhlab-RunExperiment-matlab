function [varargout]=reversecorrelationsheetlet_process(fig, typeName, ds, command, varargin)
...
if ~strcmp(command, 'GetVars')&~strcmp(command,'SetVars'),
    [rev1s,t1s,rev2s,t2s,ctredit,onoff,cb1,cb2,cb3,refCtrl]=reversecorrelationsheetlet_process(fig, typeName, ds, [typeName 'GetVars']);
end;
...
switch command,
    ...
    case 'CoarseRunBt',
        ...
        if cb3,
        	thescript = longsgs(rev1s,ctredit(1),ctredit(2),ctredit(3));
        end;
    ...
    case 'RestoreVarsBt',
        ...
        reversecorrelationsheetlet_process(fig,typeName,ds,[typeName 'SetVars'],g{:});
    case 'SaveVarsBt',
