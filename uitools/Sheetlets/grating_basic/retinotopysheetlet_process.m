function [varargout]=retinotopysheetlet_process(fig, typeName, ds, command, varargin)
...
switch command,
    ...
    case 'AnalyzeBt',
        if ~isempty(bsiCtl),
            ...
            plotlinearmap([getpathname(ds) filesep testName],'1d retinotopy','position',plotpolar,plotsingleconditions);
            return;
        end;
        refsh='ref',
        set(findobj(fig,'tag',[typeName 'GoodCB']),'userdata','');
