...
button.Callback = ['sheetlet_callback(''lengthwidthsheetlet_process'',''' typeName ''');'];
...
h = uicontrol(txt,'position',[upperLeft(1)+10 upperLeft(2)-7 90 20],'string','Length/Width:','Tag',[typeName 'LWtxt'], 'fontweight', 'bold', 'horizontalalignment', 'left');
hlist = [hlist h];
